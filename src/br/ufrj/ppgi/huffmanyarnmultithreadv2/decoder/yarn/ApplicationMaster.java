package br.ufrj.ppgi.huffmanyarnmultithreadv2.decoder.yarn;
...
public class ApplicationMaster {
	...
	public void run() throws YarnException, IOException, InterruptedException {
		...
		LOG.info("# of files: " + fileStatusArray.length);
		...
		for (FileStatus fileStatus : fileStatusArray) {
			...
			for(BlockLocation blockLocation : blockLocationArray) {
				...
				InputSplit inputSplit = new InputSplit(fileStatus.getPath().getName(), i, blockLocation.getOffset(), (int) blockLocation.getLength());
				hostInputSplit.get(hostName).add(inputSplit.toString());
				
				for(String s : blockLocation.getHosts()) {
					LOG.debug("File:" + fileStatus.getPath().getName() + " -> HostLocation " + i + ": " + s + ", offset: " + blockLocation.getOffset() + ", length: " + blockLocation.getLength());
					LOG.debug("File:" + fileStatus.getPath().getName() + " -> HostLocation " + i + ": " + s + ", offset: " + blockLocation.getOffset() + ", length: " + blockLocation.getLength());
				}
	...
	private class LaunchContainerRunnable implements Runnable {
		...
		public void run() {
			...
			// Class to execute
			vargs.add(Decoder.class.getName());
